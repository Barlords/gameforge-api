package fr.esgi.gameforgeapi.bootstrap.server;
...
import static fr.esgi.gameforgeapi.bootstrap.PackagesAndLayers.SERVER_PACKAGE;

@AnalyzeClasses(
        packages = "fr.esgi.gameforgeapi.server",
        cacheMode = FOREVER,
